...
DDoS Saldırı Simülasyonu: Dış dünyadan (Cloud) gelen trafik patlamasının tüm ağ üzerindeki etkisini (kırmızı alarm modu) görselleştirir.
...
JavaScript: Saldırı/Savunma mantığının kurgulanması ve log terminalinin dinamik yönetimi.

Not: Projenin geliştirme sürecinde, özellikle JavaScript mantığı ve Log Terminali yapısının kurgulanmasında yapay zeka desteğinden faydalanılmıştır.
